            ...
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Sir Molefi Liphakoe</td>
                                            <td>5732185</td>
                                            <td>Peka Ha Lesapo</td>
                                        ...
                                        <tr>
                                            <td>Sir Liteboho Pampiri</td>
                                            <td>5947256</td>
                                            <td>Maseru Ha Pita</td>
                                            <td>ggggggg@gmail.com</td>
                                            <td>Pampiri</td>
                                            <td>*********</td>
                                            <td><span class="badge badge-primary">User 1</span></td>
                    ...
                    <div class="form-group">
                        <label for="company" class=" form-control-label">Police Name :</label>
